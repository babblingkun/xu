...
var result = confirm('無断転載・保存厳禁】当サイト内のすべてのコンテンツ（文章・画像等）の著作権は当サイト運営者に帰属します。無許可での転載、複製、ダウンロード、保存、改変等の行為は、法律により罰せられます。【严禁转载和保存】 本网站内的所有内容（文字、图片等）的版权归本网站运营者所有。未经许可，禁止进行转载、复制、下载、保存、修改等行为。任何未经授权的行为将依法追究法律责任。');
